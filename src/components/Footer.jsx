    ...
    <footer className="bg-linear-to-r from-pink-500 to-red-600 py-8 px-4  rounded-xl mt-20">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-6">
        <div>
         ...
         <LuRotate3D size={25}/>
      <span className="text-xl font-bold text-gray-800 dark:text-gray-200">Movie Master Pro</span>
    </div>
          <ul className="space-y-2 mt-4">
            <li><Link to="/all-models" className="text-gray-600 dark:text-gray-200 hover:text-blue-600">All Movies</Link></li>
            <li><Link to="/add-model" className="text-gray-600 dark:text-gray-200 hover:text-blue-600">Add Movie</Link></li>
